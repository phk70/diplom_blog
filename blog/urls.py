...
from .views import PostListView, PostDetailView, post_add, PostDeleteView, post_update, posts_user, SearchResultsView, comment_add
...
urlpatterns = [
    ...
    path('post-comment/<int:pk>/', comment_add, name='comment_add'),
